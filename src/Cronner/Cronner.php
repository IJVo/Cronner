...
class Cronner
{
	...
	)
	{
		...
		$this->onTaskError[] = function (self $cronner, Exception $exception) {
	...
	{
		return $this->maxExecutionTime !== null ? $this->maxExecutionTime : null;
	}
	...
	public function addTasks($tasks): self
	{
		...
		if (in_array($tasksId, $this->registeredTaskObjects, true)) {
